...
これはチャンネル「#homepage」の始まりです。
Nitta Saya — 2026/01/05 19:53
https://docs.google.com/spreadsheets/d/1xPkisN8LOVkcNGYmXC8knuvewhPD-G8CysbVOaIwDVk/edit?usp=sharing
Google Docs
iGEM　ホームページ
画像
これでタスク管理をしたいらしいです
西坂勇星 — 2026/01/05 21:07
@Haruto Nakamura 
メンバー紹介に使えるような、メンバーへのインタビューがあると聞いたのですが、詳細を教えていただけませんか？
Haruto Nakamura — 2026/01/05 21:08
それはまだないです。
これから作っていく感じです
予定してた感じとしては
協力的なＯＢＯＧの方にiGEMでの経験などインタビューしてそれを載せるかんじです
2021のときの「iGEMからの贈り物」企画のときの記事をイメージしてます
西坂勇星 — 2026/01/05 21:11
中村さんが主導でしていただける感じですか？それとも、１回生がメインですべきですか？
Haruto Nakamura — 2026/01/05 21:13
やるなら僕中心に２回生などでやろうと思ってます
まぁそこそこ時間はかかると思います
西坂勇星 — 2026/01/05 21:16
よろしくお願いします
ホームページはできるだけ早く実装したいらしいので、インタビューは後に実装しようと考えているらしいです
手伝えることがあれば、タスクを振ってください
Haruto Nakamura — 2026/01/05 21:21
Nitta Saya — 2026/01/05 21:26
画像
画像
書き方

⚫︎マークダウン方式
⚫︎写真はこのチャンネルに投げる。ファイル名をつけ，その名前をドキュメントに入れておく。

@1回生
uz01234 — 2026/01/06 22:06
あと、写真を文章中に入れるときは、写真を直接貼り付けずに代わりにファイル名を書いて
多分、元のホームページと合体させるけど（SEOのため）、一応これが作ってるホームページね
https://igemkyotoofficial.github.io/homepage/
iGEM Kyoto
iGEM Kyoto Official Website
@anyone ↑をpinして
Nitta Saya — 2026/01/06 22:22
@everyone
Nitta Saya — 2026/01/09 20:59
https://docs.google.com/document/d/1lU6AQ5F-iiVDFaqjNdyjKdkEUb7T5LjnHCloSIBoxUY/edit?usp=sharing
uz01234 — 2026/01/11 17:38
前提が共有されてないのに具体的な話されても分かんないぜ、例えば毎年大会に向けて１からやってるみたいな前提が。多分前提を書き足したほうがいい
Nitta Saya — 2026/01/12 1:53
一年の流れみたいなのを書く導入みたいなのが必要ってことやよね？
Nitta Saya — 2026/01/12 20:13
@uz01234 
こんな感じで画像は上げるのでいい？ 
画像
画像
...
画像
画像
Makoto Kitabatake — 2026/01/14 16:55
これ拝見したのですが、連絡先として2026年メンバー限定のメールアドレスを作ったということですか？　オフィシャルの窓口は統一するべきでは？　卒業生に最新メールを読まれたくない、とかであればパスワードの変更で対応した方がいいですよね
Nitta Saya — 2026/01/14 17:02
Googleドライブを今年のものを作りたかったので新しく作ったのですが、やめたほうがいいでしょうか？
今までも作っていましたが。
Makoto Kitabatake — 2026/01/14 18:43
Googleドライブ自体は毎年作ったらいい（作った方がいい）です。しかし「お問い合わせ」のアドレスは変更すべきではないです。現状では2026のGmailに連絡先が指定されていましたが、来年や再来年になったときにお問い合わせに返信できなくなってしまいます（無視することになってしまう）。後から2027のGmailとかに変えようとしても、「すべての問い合わせ先」をもれなく変えるのは困難なので、どこかで漏れが生じ、「大事な質問をしたのに無視してくる団体なんだな」という評価につながります
Nitta Saya — 2026/01/14 18:44
ほんとですね。メールアドレスは間違いだと思います。変更しておきます。
是枝里咲 — 2026/01/15 19:41
旧ホームページの協賛のページに記載してある、2023年度アカデミストに寄付していただいた方々の名前を新しいホームページにも載せるべきでしょうか。載せる場合その方々にメールで許可とった方がいいですか？
また、その方々に今現在のクラファンの紹介をした方がいいと思うんですがどう思いますか？
また、協賛の企業5つ中現在まだ協賛してくれてるxforestと都キャピタルに新しいホームページにも掲載していいかの許可のメールを送るのはもちろんですが、もう協賛しておらず新しいホームページには載せないでおこうと思う他3つの企業にもその旨をメールで伝えた方がいいと思うのですが、いかがでしょうか。
画像
画像
Makoto Kitabatake — 2026/01/16 9:35
これは、2023のアカデミストの時に「どういう約束になっていたか」も関係してきますよね。「いつまでも載せる」と思われる書き方をしてたか、「お知らせに載せます」程度だったか。石橋くん、分かりますか？　@Ishibashi(B4)
Makoto Kitabatake — 2026/01/16 9:44
ホームページ改変にあたって引き継いでもいいような気もしますが、それだと今回のキャンプファイアの支援者も載せる、ということになり、iGEM Kyoto同窓生の人たちにとっては直接郵便貯金に寄付するメリットが分かりにくいですね。掲載欄を変える、文字の大きさやコメント有無を変える、など差別化をしないとトラブルになりそうです。

実際のところ支援者の中には、「郵便貯金」「京大基金」「クラウドファンディング」の３つのカテゴリーがあり、この順番に控除率が低く、望ましいんですよね。１万円投げてもらうとして、受け取るのはこの順番に10,000円、9,500円、8,000円のはず。投げる側のメリットは、何もしなければこの順番に「なし」「税制優遇」「クラファンサイトで露出」になっており、「チームにお金を多く入れた」人ほど損する仕組みになっています。
Ishibashi(B4) — 2026/01/16 9:49
文面上は「iGEM Kyotoのwebページにお名前を掲載」と書いていて、ずっと載せるともとれる書き方になっていました
2023年のクラウドファンディングの分はトグルにして、ボタンを押したら見れるような形にしてもいいのかなとは思いました 
浅井知顕 — 2026/01/16 13:17
https://docs.google.com/document/d/1hwsk6EEInGLjx8KD8i0JXSfLgjvlpY_uc0V2B4Art8Q/edit?usp=drive_link
Nitta Saya — 2026/01/16 14:16
https://docs.google.com/document/d/1SyPYFjBOTOcruVQDcXoGrJDhAbgIWJvJXfLLTHNE3tI/edit?usp=sharing
Google Docs
MEMBER
MEMBER 新田紗也（Saya　Nitta） Grade：２回生 Fculty：農学部 Role：チームリーダー、HP、Wet Hobby：お菓子作り、運動 一言：
画像
是枝里咲 — 2026/01/16 17:51
https://docs.google.com/document/d/1PDG6c5CPtrr_dwYtCZhJOSWuFsMdrhs9QmydS7dlmTs/edit?usp=drivesdk

トグルのやり方わかりません。
@uz01234 スポンサーのとこ石橋さんの仰っているように2023年のクラファン一覧をトグルに直す訂正お願いしていいですか？
Google Docs
協賛と寄付
支援のお願い 私たちを応援してくださる企業・個人の方を募集しております 写真1 次世代を担う合成生物学の旗手として iGEM Kyotoは、次世代の基幹技術である合成生物学に情熱を注ぎ、その可能性を追求する京都大学の学生チームです。 今、合成生物学は...
画像
Nitta Saya — 2026/01/19 18:58
# HOME

[マークダウン(Markdown)記法完全チートシート \#Markdown記法 \- Qiita](https://qiita.com/masterpiecehack/items/990683b706b70b88b4c7)
...
5 KB
Nitta Saya
 がメッセージをチャンネルにピン留めしました。ピン留めされたメッセージを全て表示。 — 2026/01/19 20:27
uz01234 — 2026/01/19 20:30
これにISSUEシート作ったので、問題点がある場合はそこで指摘してください
Nitta Saya — 2026/01/19 21:04
この文章、今書いてる内容は完璧らしいんやけどもう少しiGEMの大会での楽しみ的なことも入れてほしいらしいです。学生同士の交流とかかなと。
西坂勇星 — 2026/01/23 12:42
@uz01234 
遅くなりましたが、よろしくお願いします
# PROJECT
...
画像
画像
あと、写真はGitHubの権限がないので上げられないので、よろしくお願いします
浅井知顕 — 2026/01/23 20:00
なんとなくそんな感じの内容を書き加えました。
画像
# 写真について
下のフォーマットでgitの指定の場所に保存してください
![適当にタイトルつけて](/homepage/images/example.png)
﻿
# PROJECT

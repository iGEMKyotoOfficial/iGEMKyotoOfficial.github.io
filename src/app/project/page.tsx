      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className={proseClasses}>
          ...
          <section className="mt-8">
            ...
            <p className="mt-2">
              <a href="https://2025.igem.wiki/kyoto/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
              <br />
              <a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:6545fa8f-c411-402d-a131-f5463179b681" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">ポスターはこちら</a>
            </p>
          </section>
          ...
          <details className="group mt-8 rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/50">
            ...
            <div className="border-t border-gray-200 px-5 pb-5 pt-4 dark:border-gray-700">
              <section className="mt-8 first:mt-4">
                ...
                <p className="mt-2">
                  <a href="https://2024.igem.wiki/kyoto/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                  <br />
                  <a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:4332e588-11c9-4d01-a8bd-85d43d3df019" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">ポスターはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  ...
                  その解決策として、シカの忌避物質を持続的に生産・放出する新しいソリューションを考案しました。これは実際使うことになる農家さんの負担にならないよう、自律的に大腸菌を長期間培養させる必要がありました。そこで、自身の個体数を抑制し、死滅した細胞から栄養をリサイクルするようプログラムすることにしました。さらに、攪拌震盪を自動化するために、水の気化潜熱のみを動力源とするDrinking Birdというおもちゃを元に安価でメンテナンスの容易な装置も設計しました。
                ...
                <p className="mt-2">
                  ...
                  <br />
                  <a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:94cf3421-c50c-48fd-adcb-1dcce6bafea4" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">ポスターはこちら</a>
                  <br />
                  <a href="https://www.kyoto-u.ac.jp/ja/research-news/2023-05-17-0" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">https://www.kyoto-u.ac.jp/ja/research-news/2023-05-17-0</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2">
                  <a href="https://2021.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                  <br />
                  <a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:4301a0f6-9992-4d03-b337-1f73899387ab" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">ポスターはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  ...
                  大会ではプレゼン、ポスターセッション共に高い評価を受け金賞、その上EnvironmentとBest Parts Collectionという部門賞に最終候補にノミネートされました。
                </p>
                <p className="mt-2">
                  <a href="https://2019.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                  <br />
                  <a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:4301a0f6-9992-4d03-b337-1f73899387ab" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">ポスターはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  ...
                  大会では、Gold Criteriaになっていた「Parts Improvement」に関する結果を審査員にきちんと伝えることができなかったのか、悔しくも銀メダルの受賞となりました。
                </p>
                <p className="mt-2">
                  <a href="https://2018.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  ...
                  松を食い荒らし、松枯れ病という病気の原因であるマツノザイセンチュウ（B. xylophilus）という小さな虫を駆除するため、その虫に毒性のあるRNA分子を酵母に発現させ、酵母を食べさせることでマツノザイセンチュウを殺虫することを試みました。
                ...
                <p className="mt-2">
                  <a href="https://2017.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2">
                  <a href="https://2016.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  2014年度のテーマは&quot;Magnetosome Formation&quot;と&quot;DMS Synthesis&quot;です。
                  Magnetosome Formationでは、磁性を持つ大腸菌を実現しようとしました。大腸菌を磁力で動かせるようにすることで、大腸菌の回収や制御を簡単に行うことができるようになります。
                  DMS Synthesisでは、小さな大腸菌から大きな雲をつくるというような、夢のような研究を行いました。雲の凝結核の元となる物質であるジメチルスルフィド（DMS）を大腸菌で生合成することを目指しました。
                  Giant Jamboreeでは見事金メダルを獲得しました。
                </p>
                <p className="mt-2">
                  <a href="https://2014.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  2013年度のテーマは&quot;RNA Oscillator&quot;と&quot;Pattern Generation&quot;です。
                  この2つのシステムを用いて、WetワークとDryワークの間の隔たりについて理解し、そのギャップを埋める方法について考察しました。
                  RNA Oscillatorは、RNAを用いて点滅のような振動を表現しようと、Wet LabとDry Labの両方から研究を行いました。
                  Pattern Generationでは、動物の体表などに現れる模様のパターンの再現を目指しました。
                  アジア予選では、銀メダルを獲得しました。
                </p>
                <p className="mt-2">
                  <a href="https://2013.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2">
                  <a href="https://2012.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2">
                  <a href="https://2011.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  2010年度のプロジェクトは&quot;The Fantastic Lysisbox&quot;です。
                  バイオハザードの対策を考える中で細胞を溶かすことに注目しました。これはバイオハザードの防止だけでなく、製薬やさらに身近な例としてはバイオアロマなどにも応用できる優れたデバイスです。
                  大会は11/5〜11/8にかけて行われ、金賞を受賞しました。
                </p>
                <p className="mt-2">
                  <a href="https://2010.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  「今年こそは」と意気込んだ2009年は、さらにユニークなプロジェクト&quot;Time Bomb&quot;と&quot;Cells in cells&quot;を立ち上げました。
                  Time Bombでは、治療目的で体内に投与する細菌を所望の時期と細胞数で細菌を人体から除去するために、細菌が一定回数の細胞分裂を行うと、キラー遺伝子など目的の遺伝子を発現する仕組みを設計しました。
                  Cells in cellsでは、ミトコンドリアや葉緑体のように、細胞内共生を人工的に実現することを目指しました。
                  主に夏休みの期間を利用して遂行し、銀賞を受賞しました。
                </p>
                <p className="mt-2">
                  <a href="https://2009.igem.org/Team:Kyoto/GSDD/Abstract" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  ...
                  テーマ&quot;Raise the Titanic!&quot;では、大腸菌を用いてタイタニック号を引き上げることを目指しました。
                  独創性は群を抜いていましたが、残念ながら入賞を逃しました。
                </p>
                <p className="mt-2">
                  <a href="https://2008.igem.org/Team:Kyoto" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">wikiはこちら</a>
                </p>
              </section>
            </div>
          </details>

    ...
    <Contain>
      ...
      <div className="pagination-wrapper">
        <div className="pagination">
          <Link className="prev page-numbers" href="/2021">
            prev
          </Link>
          ...
          <Link className="next page-numbers" href="/2019">
            next
          </Link>
        </div>
      </div>
      ...
      <Frame subtitle="	芝 雄介 (Yusuke SHIBA)" src={shiba}>
        Sophomore of the Department of Bioresource Science, Faculty of
      ...
      <Frame subtitle="	山内 萌々乃 (Momono YAMAUCHI)" src={yamauchi}>
        Junior of the Department of Human Health Science, the Faculty of
        Medicine, Kyoto University <br />
        赤血球とぺんぎんとごはんの時間
      </Frame>
      <br />
      <Frame subtitle="	池田 雄太郎 (Yutaro IKEDA)" src={ikeda}>
        Sophomore of the Faculty of Science, Kyoto University <br />A piece of
        cake!
      </Frame>
      <br />
      ...
      <Frame subtitle="	西澤 知里 (Chisato NISHIZAWA)" src={nishizawa}>
        Sophomore of the Department of Applied Life Sciences, Faculty of
        Agriculture, Kyoto University <br />I appreciate being blessed with
        wonderful colleagues. May this difficult year become worthwhile!
      </Frame>
      <br />
      ...
      <Frame subtitle="	合屋 智尋 (Chihiro GOYA)" src={goya}>
        Freshman of the Department of Medicine, Faculty of Medicine, Kyoto
        University <br />
        おなかすいた
      </Frame>
      <br />

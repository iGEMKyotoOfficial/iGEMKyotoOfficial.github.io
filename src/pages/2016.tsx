  ...
  return (
    <Contain>
      ...
      <Frame subtitle="道盛 裕太 (Yuta MICHIMORI)" src={michimori}>
        Sophomore of the Department of Industrial Chemistry, Faculty of
      ...
      <Frame subtitle="井口 聖大 (Takahiro IGUCHI)" src={iguchi}>
        Sophomore of the Department of Food Science and Biotechnology, Faculty
        of Agriculture, Kyoto University <br />
      ...
      <Frame subtitle="山本 衣里奈 (Erina YAMAMOTO)" src={yamamoto}>
        Sophomore of he Department of Medical Science, Faculty of Medicine,
        Kyoto University <br />
        ひとつひとつ 一歩一歩
      </Frame>
      <br />
      ...
      <Frame subtitle="山田 修平 (Shuhei YAMADA)" src={yamada}>
        Sophomore of the Department of Physics and Engineering, Faculty of
        Engineering, Kyoto University <br />
      ...
      <Frame subtitle="松本 宙 (Sora MATSUMOTO)" src={matsumoto}>
        Junior of the Department of Applied Life Sciences, Faculty of
        Agriculture, Kyoto University <br />I have a dream.
      </Frame>
      <br />
      ...
      <Frame subtitle="中村 元春 (Motoharu NAKAMURA)" src={nakamura}>
        Junior of the Department of Applied Life Sciences, Faculty of
        Agriculture, Kyoto University <br />I want money.
      </Frame>
      <br />
      <Frame subtitle="佐々 裕成 (Hironari SASSA)" src={Sassahironari}>
        Freshman of the Department of Industrial Chemistry, Faculty of
        Engineering, Kyoto University <br />
        ←This is a pair of glasses which consists of chemistry and synthetic
        biology, please handle it with care.
      </Frame>
      <br />
      ...
      <Frame subtitle="小出 英里 (Eri KOIDE)" src={Koide3}>
        ...
        Engineering, Faculty of Agriculture, Kyoto University <br />I wonder if
        I can make antibody with this rabbit...
      </Frame>
      <br />
      <Frame subtitle="小原 乃也 (Daiya OHARA)" src={Oharadaiya2}>
        Freshman of the Department of Bioresource Sciences, Faculty of
        Agriculture, Kyoto University <br />
        YMW(やってみないとわからない)
      </Frame>
      <br />
